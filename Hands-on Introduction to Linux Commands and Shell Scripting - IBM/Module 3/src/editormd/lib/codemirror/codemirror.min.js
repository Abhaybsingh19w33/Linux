...
!function(e, t) {
    ...
    function b(e, t) {
        var r;
        return Object.create ? r = Object.create(e) : (y.prototype = e,
        r = new y),
        t && c(t, r),
        r
    }
    ...
    function L(e, t, r) {
        for (; (r < 0 ? t > 0 : t < e.length) && S(e.charAt(t)); )
            t += r;
        return t
    }
    function k(e, t, r) {
    ...
    function M(e, t, r) {
        ...
        for (var i = 0; i < e.length; ++i) {
            ...
            if (o.from < t && o.to > t)
                return i;
            o.to == t && (o.from != o.to && "before" == r ? n = i : es = i),
            o.from == t && (o.from != o.to && "before" != r ? n = i : es = i)
        }
        return null != n ? n : es
    }
    function N(e, t) {
        var r = e.order;
        return null == r && (r = e.order = ts(e.text, t)),
        r
    }
    function O(e, t) {
        return e._handlers && e._handlers[t] || rs
    }
    function A(e, t, r) {
    ...
    function U(e) {
        if (null == Kl) {
            ...
            0 != e.firstChild.offsetHeight && (Kl = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(Cl && Sl < 8))
        }
        var i = Kl ? n("span", "​") : n("span", " ", null, "display: inline-block; width: 1px; margin-right: -1px");
    ...
    function V(e) {
        ...
        var n = r(e, document.createTextNode("AخA"))
          , i = Rl(n, 0, 1).getBoundingClientRect()
          , o = Rl(n, 1, 2).getBoundingClientRect();
        return t(e),
        !(!i || i.left == i.right) && (jl = o.right - i.right < 3)
    }
    function K(e) {
        if (null != as)
            return as;
        ...
        return as = Math.abs(i.left - o.left) > 1
    }
    function j(e, t) {
    ...
    function Y(e) {
        if ("string" == typeof e && cs.hasOwnProperty(e))
            e = cs[e];
    ...
    function _(e, t) {
        c(t, hs.hasOwnProperty(e) ? hs[e] : hs[e] = {})
    }
    function q(e, t) {
        if (!0 === t)
            return t;
    ...
    function ne(e) {
        if (null == e.parent)
            return null;
        for (var t = e.parent, r = f(t.lines, e), n = t.parent; n; t = n,
        n = n.parent)
    ...
    function pe(e, t) {
        ...
        return t.line > r ? se(r, J(e, r).text.length) : ge(t, J(e, t.line).text.length)
    }
    function ge(e, t) {
        var r = e.ch;
    ...
    function me(e, t, r, n) {
        var i = [e.state.modeGen]
          , o = {};
        ke(e, t.text, e.doc.mode, r, function(e, t) {
            return i.push(e, t)
        }, o, n);
        for (var l = r.state, s = function(n) {
            ...
            var s = e.state.overlays[n]
              ...
              , u = 0;
            r.state = !0,
            ke(e, t.text, s.mode, r, function(e, t) {
                for (var r = a; u < e; ) {
                    var n = i[a];
    ...
    function ye(e, t, r) {
        if (!t.styles || t.styles[0] != e.state.modeGen) {
            var n = be(e, ne(t))
              , i = t.text.length > e.options.maxHighlightLength && q(e.doc.mode, n.state)
              , o = me(e, t, n);
            i && (n.state = i),
    ...
    function be(e, t, r) {
        ...
        var o = Te(e, t, r)
          ...
          , s = l ? ps.fromSaved(n, l, o) : new ps(n,Q(n.mode),o);
    ...
    function we(e, t, r, n) {
        var i = e.doc.mode
          , o = new fs(t,e.options.tabSize,r);
        for (o.start = o.pos = n || 0,
        "" == t && xe(i, r.state); !o.eol(); )
            Ce(i, o, r.state),
            o.start = o.pos
    }
    function xe(e, t) {
    ...
    function Se(e, t, r, n) {
        ...
        for (n && (s = []); (n || c.pos < t.ch) && !c.eol(); )
            c.start = c.pos,
            i = Ce(l, c, u.state),
            n && s.push(new gs(c,i,q(o.mode, u.state)));
        return n ? s : new gs(c,i,u.state)
    }
    function Le(e, t) {
        if (e)
            for (; ; ) {
    ...
    function ke(e, t, r, n, i, o, l) {
        ...
        for ("" == t && Le(xe(r, n.state), o); !h.eol(); ) {
            ...
            l && we(e, t, n, h.pos),
            h.pos = t.length,
            a = null) : a = Le(Ce(r, h, n.state, f), o),
            f) {
                var d = f[0].name;
                d && (a = "m-" + (a ? d + " " + a : d))
            }
    ...
    function Te(e, t, r) {
        for (var n, i, o = e.doc, l = r ? -1 : t - (e.doc.mode.innerMode ? 1e3 : 100), s = t; s > l; --s) {
            ...
            var a = J(o, s - 1)
              , u = a.stateAfter;
            if (u && (!r || s + (u instanceof ds ? u.lookAhead : 0) <= o.modeFrontier))
                return s;
    ...
    function Me(e, t) {
        ...
        !(e.highlightFrontier < t - 10)) {
            for (var r = e.first, n = t - 1; n > r; n--) {
                ...
                if (i && (!(i instanceof ds) || n + i.lookAhead < t)) {
                    r = n + 1;
                    break
                }
            }
    ...
    function He(e, t, r) {
        ...
        n && n.has(e.markedSpans) ? e.markedSpans.push(t) : (e.markedSpans = e.markedSpans ? e.markedSpans.concat([t]) : [t],
        ...
        if (e)
            for (var i = 0; i < e.length; ++i) {
                ...
                if (s || o.from == t && "bookmark" == l.type && (!r || o.marker.insertLeft)) {
                    ...
                    (n || (n = [])).push(new Ae(l,a ? null : o.from - t,null == o.to ? null : o.to - t))
                }
            }
        return n
    }
        ...
        if (!u) {
            ...
            if (w > 0 && s)
                for (var x = 0; x < s.length; ++x)
                    null == s[x].to && (b || (b = [])).push(new Ae(s[x].marker,null,null));
            for (var C = 0; C < w; ++C)
                y.push(b);
            y.push(a)
        }
    ...
    function Ke(e, t) {
        var r, n = ms && e.markedSpans;
        if (n)
            for (var i = void 0, o = 0; o < n.length; ++o)
                i = n[o],
                i.marker.collapsed && null == (t ? i.from : i.to) && (!r || Ve(r, i.marker) < 0) && (r = i.marker);
        return r
    }
    function je(e) {
        return Ke(e, !0)
    ...
    function Ye(e, t) {
        ...
        if (n)
            for (var i = 0; i < n.length; ++i) {
                var o = n[i];
                o.marker.collapsed && (null == o.from || o.from < t) && (null == o.to || o.to > t) && (!r || Ve(r, o.marker) < 0) && (r = o.marker)
            }
        return r
    }
        ...
        if (l)
            for (var s = 0; s < l.length; ++s) {
                ...
                if (a.marker.collapsed) {
                    ...
                    if (!(c >= 0 && h <= 0 || c <= 0 && h >= 0) && (c <= 0 && (a.marker.inclusiveRight && i.inclusiveLeft ? ae(u.to, r) >= 0 : ae(u.to, r) > 0) || c >= 0 && (a.marker.inclusiveRight && i.inclusiveLeft ? ae(u.from, n) <= 0 : ae(u.from, n) < 0)))
                        return !0
                }
            }
    }
        ...
        if (r)
            for (var n = void 0, i = 0; i < r.length; ++i)
                ...
                n.marker.collapsed) {
                    if (null == n.from)
                        return !0;
                    if (!n.marker.widgetNode && 0 == n.from && n.marker.inclusiveLeft && tt(e, t, n))
                        return !0
                }
    }
    function tt(e, t, r) {
        ...
        for (var i = void 0, o = 0; o < t.markedSpans.length; ++o)
            ...
            i.marker.collapsed && !i.marker.widgetNode && i.from == r.to && (null == i.to || i.to != r.from) && (i.marker.inclusiveLeft || r.marker.inclusiveRight) && tt(e, t, i))
                return !0
    }
    function rt(e) {
        e = _e(e);
    ...
    function at(e, t) {
        ...
        for (var o = 0; o <= (t.rest ? t.rest.length : 0); o++) {
            ...
            n.pos = 0,
            n.addToken = ct,
            V(e.display.measure) && (s = N(l, e.doc.direction)) && (n.addToken = ft(n.addToken, s)),
            n.map = [];
            pt(l, n, ye(e, l, t != e.display.externalMeasured && ne(l))),
            ...
            0 == n.map.length && n.map.push(0, 0, n.content.appendChild(U(e.display.measure))),
        ...
        return D(e, "renderLine", e, t.line, n.pre),
    ...
    function ct(e, t, r, i, o, l, s) {
        if (t) {
            var a, u = e.splitSpaces ? ht(t, e.trailingSpace) : t, c = e.cm.state.specialChars, h = !1;
            if (c.test(t)) {
                ...
                for (var f = 0; ; ) {
                    ...
                    if ("\t" == d[0]) {
                        ...
                        "\r" == d[0] || "\n" == d[0] ? (m = a.appendChild(n("span", "\r" == d[0] ? "␍" : "␤", "cm-invalidchar")),
                        m.setAttribute("cm-text", d[0]),
                        e.col += 1) : (m = e.cm.options.specialCharPlaceholder(d[0]),
                        m.setAttribute("cm-text", d[0]),
    ...
    function ft(e, t) {
        return function(r, n, i, o, l, s, a) {
            ...
            for (var u = r.pos, c = u + n.length; ; ) {
                for (var h = void 0, f = 0; f < t.length && (h = t[f],
                !(h.to > u && h.from <= u)); f++)
                    ;
                if (h.to >= c)
                ...
                if (m == p) {
                    ...
                    if (!h || h.from == p)
                        for (var k = 0; k < y.length; ++k)
                            dt(t, 0, y[k]);
                    if (h && (h.from || 0) == p) {
                        if (dt(t, (null == h.to ? d + 1 : h.to) - p, h.marker, null == h.from),
                        null == h.to)
                            return;
                        h.to == p && (h = !1)
                    }
    ...
    function mt(e) {
        Cs ? Cs.ops.push(e) : e.ownsGroup = Cs = {
            ops: [e],
            delayedCallbacks: []
        }
    }
    ...
    function wt(e, t) {
        ...
        if (r.length) {
            ...
            Cs ? n = Cs.delayedCallbacks : Ss ? n = Ss : (n = Ss = [],
            setTimeout(xt, 0));
    ...
    function Ct(e, t, r, n) {
        for (var i = 0; i < t.changes.length; i++) {
            var o = t.changes[i];
            "text" == o ? Tt(e, t) : "gutter" == o ? Nt(e, t, r, n) : "class" == o ? Mt(e, t) : "widget" == o && Ot(e, t, n)
        }
        t.changes = null
    }
    function St(e) {
    ...
    function Tt(e, t) {
        ...
        Mt(e, t)) : r && (t.text.className = r)
    }
    function Mt(e, t) {
        Lt(e, t),
        t.line.wrapClass ? St(t).className = t.line.wrapClass : t.node != t.text && (t.node.className = "");
    ...
    function Nt(e, t, r, i) {
        ...
        if (e.options.lineNumbers || l) {
            ...
            if (a.setAttribute("aria-hidden", "true"),
            e.display.input.setUneditable(a),
            s.insertBefore(a, t.text),
            t.line.gutterClass && (a.className += " " + t.line.gutterClass),
            !e.options.lineNumbers || l && l["CodeMirror-linenumbers"] || (t.lineNumber = a.appendChild(n("div", le(e.options, r), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + i.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))),
            l)
    ...
    function Ot(t, r, n) {
        ...
        for (var i = e("CodeMirror-linewidget"), o = r.node.firstChild, l = void 0; o; o = l)
            l = o.nextSibling,
    ...
    function Wt(e, t, r, i, o) {
        if (t.widgets)
            for (var l = St(r), s = 0, a = t.widgets; s < a.length; ++s) {
                var u = a[s]
                  , c = n("div", [u.node], "CodeMirror-linewidget" + (u.className ? " " + u.className : ""));
    ...
    function zt(e) {
        return Xl - e.display.nativeBarWidth
    }
    function Bt(e) {
    ...
    function Yt(e, t) {
        var r = ne(t)
          , n = Xt(e, r);
        n && !n.text ? n = null : n && n.changes && (Ct(e, n, r, wr(e)),
    ...
    function $t(e, t, r, n, i) {
        ...
        t.hasHeights || (Ut(e, t.view, t.rect),
        t.hasHeights = !0),
        o = Zt(e, t, r, n),
        o.bogus || (t.cache[l] = o)),
        {
    ...
    function _t(e, t, r) {
        for (var n, i, o, l, s, a, u = 0; u < e.length; u += 3)
            ...
            o = 1,
            l = "left") : t < a ? (i = t - s,
            o = i + 1) : (u == e.length - 3 || t == a && e[u + 3] > t) && (o = a - s,
            i = o - 1,
            t >= a && (l = "right")),
            null != i) {
                if (n = e[u + 2],
    ...
    function Zt(e, t, r, n) {
        var i, o = _t(t.map, r, n), l = o.node, s = o.start, a = o.end, u = o.collapse;
        if (3 == l.nodeType) {
            for (var c = 0; c < 4; c++) {
                ...
                for (; o.coverStart + a < o.coverEnd && S(t.line.text.charAt(o.coverStart + a)); )
                    ++a;
                if (i = Cl && Sl < 9 && 0 == s && a == o.coverEnd - o.coverStart ? l.parentNode.getBoundingClientRect() : qt(Rl(l, s, a).getClientRects(), n),
                i.left || i.right || 0 == s)
                    break;
                a = s,
                s -= 1,
    ...
    function Qt(e, t) {
        if (!window.screen || null == screen.logicalXDPI || screen.logicalXDPI == screen.deviceXDPI || !K(e))
            return t;
    ...
    function rr() {
        return Tl && Wl ? -(document.body.getBoundingClientRect().left - parseInt(getComputedStyle(document.body).marginLeft)) : window.pageXOffset || (document.documentElement || document.body).scrollLeft
    }
    function nr() {
        return Tl && Wl ? -(document.body.getBoundingClientRect().top - parseInt(getComputedStyle(document.body).marginTop)) : window.pageYOffset || (document.documentElement || document.body).scrollTop
    }
    function ir(e) {
        var t = _e(e)
          , r = t.widgets
    ...
    function or(e, t, r, n, i) {
        ...
        n || (n = "local");
        var l = rt(t);
        if ("local" == n ? l += Et(e.display) : l -= e.display.viewOffset,
        "page" == n || "window" == n) {
    ...
    function sr(e, t, r, n, i) {
        return n || (n = J(e.doc, t.line)),
        or(e, n, jt(e, n, t.ch, i), r)
    }
    function ar(e, t, r, n, i, o) {
        function l(t, l) {
            var s = $t(e, i, t, l ? "right" : "left", o);
    ...
    function ur(e, t) {
        var r = 0;
        t = pe(e.doc, t),
        e.options.lineWrapping || (r = br(e.display) * t.ch);
    ...
    function hr(e, t, r) {
        ...
        var i = ie(n, r)
          , o = n.first + n.size - 1;
        if (i > o)
            return cr(n.first + n.size - 1, J(n, o).text.length, null, 1, 1);
        t < 0 && (t = 0);
        for (var l = J(n, i); ; ) {
            var s = gr(e, l, i, t, r)
    ...
    function fr(e, t, r, n) {
        ...
        var i = t.text.length
          , o = k(function(t) {
            return $t(e, r, t - 1).bottom <= n
        }, i, 0);
        return i = k(function(t) {
            return $t(e, r, t).top > n
        }, o, i),
        {
            begin: o,
            end: i
    ...
    function dr(e, t, r, n) {
        return r || (r = Yt(e, t)),
        fr(e, t, r, or(e, t, $t(e, r, n), "line").top)
    }
    function pr(e, t, r, n) {
    ...
    function gr(e, t, r, n, i) {
        ...
        var f, d, p = null, g = null, v = k(function(t) {
            var r = $t(e, o, t);
            return r.top += l,
            r.bottom += l,
            !!pr(r, n, i, !1) && (r.top <= i && r.left <= n && (p = t,
            g = r),
            !0)
        }, s, a), m = !1;
        if (g) {
            ...
            u || v != a && v != s || v++,
            d = 0 == v ? "after" : v == t.text.length ? "before" : $t(e, o, v - (u ? 1 : 0)).bottom + l <= i == u ? "after" : "before";
            var w = ar(e, se(r, v, d), "line", t, o);
            f = w.left,
            m = i < w.top ? -1 : i >= w.bottom ? 1 : 0
        }
        return v = L(t.text, v, 1),
        cr(r, v, d, m, n - f)
    }
    function vr(e, t, r, n, i, o, l) {
        var s = k(function(s) {
            var a = i[s]
              , u = 1 != a.level;
            return pr(ar(e, se(r, u ? a.to : a.from, u ? "before" : "after"), "line", t, n), o, l, !0)
        }, 0, i.length - 1)
          , a = i[s];
        if (s > 0) {
            var u = 1 != a.level
              , c = ar(e, se(r, u ? a.from : a.to, u ? "after" : "before"), "line", t, n);
    ...
    function mr(e, t, r, n, i, o, l) {
        ...
        for (var c = null, h = null, f = 0; f < i.length; f++) {
            ...
            if (!(d.from >= u || d.to <= a)) {
                var p = 1 != d.level
                  , g = $t(e, n, p ? Math.min(u, d.to) - 1 : Math.max(a, d.from)).right
                  , v = g < o ? o - g + 1e9 : g - o;
                (!c || h > v) && (c = d,
                h = v)
            }
    ...
    function yr(e) {
        ...
        if (null == bs) {
            bs = n("pre", null, "CodeMirror-line-like");
            for (var i = 0; i < 49; ++i)
    ...
    function Lr(e, t, r, n) {
        var i = e.display;
        if (!r && "true" == B(t).getAttribute("cm-not-content"))
            return null;
        ...
        if (n && u.xRel > 0 && (a = J(e.doc, u.line).text).length == u.ch) {
            ...
            u = se(u.line, Math.max(0, Math.round((o - Rt(e.display).left) / br(e.display)) - c))
        }
        return u
    }
    function kr(e, t) {
    ...
    function Tr(e, t, r, n) {
        ...
        t >= i.viewTo)
            ms && Qe(e.doc, t) < i.viewTo && Nr(e);
        else if (r <= i.viewFrom)
            ms && Je(e.doc, r + n) > i.viewFrom ? Nr(e) : (i.viewFrom += n,
            i.viewTo += n);
            ...
            i.viewTo = l.lineN) : Nr(e)
        } else {
            var s = Or(e, t, t, -1)
              , a = Or(e, r, r + n, 1);
            s && a ? (i.view = i.view.slice(0, s.index).concat(vt(e, s.lineN, a.lineN)).concat(i.view.slice(a.index)),
            i.viewTo += n) : Nr(e)
        }
    ...
    function Or(e, t, r, n) {
        var i, o = kr(e, t), l = e.display.view;
        if (!ms || r == e.doc.first + e.doc.size)
            return {
                index: o,
                lineN: r
            };
    ...
    function Ar(e, t, r) {
        var n = e.display;
        0 == n.view.length || t >= n.viewTo || r <= n.viewFrom ? (n.view = vt(e, t, r),
        n.viewFrom = t) : (n.viewFrom > t ? n.view = vt(e, t, n.viewFrom).concat(n.view) : n.viewFrom < t && (n.view = n.view.slice(kr(e, t))),
        n.viewFrom = t,
        n.viewTo < r ? n.view = n.view.concat(vt(e, n.viewTo, r)) : n.viewTo > r && (n.view = n.view.slice(0, kr(e, r)))),
        n.viewTo = r
    }
    function Dr(e) {
    ...
    function Fr(e, t, r) {
        ...
        /\bcm-fat-cursor\b/.test(e.getWrapperElement().className)) {
            var l = sr(e, t, "div", null, null)
              , s = l.right - l.left;
            o.style.width = (s > 0 ? s : e.defaultCharWidth()) + "px"
        }
        if (i.other) {
    ...
    function Er(e, t, r) {
        ...
        function o(t, r, n) {
            ...
            var a, u, d = J(s, t), p = d.text.length, g = N(d, s.direction);
            return T(g, r || 0, null == n ? p : n, function(e, t, s, d) {
                var v = "ltr" == s
                  , m = o(e, v ? "left" : "right")
                ...
                if (y.top - m.top <= 3) {
                    ...
                    N = f ? h : l(e, s, "before"),
                    O = f ? c : l(t, s, "after"),
                    A = f && w && C ? h : y.right) : (M = f ? l(e, s, "before") : c,
                    N = !f && b && x ? h : m.right,
                    O = !f && w && C ? c : y.left,
                    A = f ? l(t, s, "after") : h),
    ...
    function Gr(e, t) {
        e.state.delayingBlurEvent || (e.state.focused && (D(e, "blur", e, t),
        e.state.focused = !1,
        ...
        for (var t = e.display, r = t.lineDiv.offsetTop, n = Math.max(0, t.scroller.getBoundingClientRect().top), i = t.lineDiv.getBoundingClientRect().top, o = 0, l = 0; l < t.view.length; l++) {
            ...
            if (!s.hidden) {
                ...
                Cl && Sl < 8) {
                    ...
                    u = f.bottom - f.top,
                    !a && s.text.firstChild && (c = s.text.firstChild.getBoundingClientRect().right - f.left - 1)
                }
                var d = s.line.height - u;
                if ((d > .005 || d < -.005) && (i < n && (o -= d),
                re(s.line, u),
                Vr(s.line),
                s.rest))
                ...
                if (c > e.display.sizerWidth) {
                    var g = Math.ceil(c / br(e.display));
                    g > e.display.maxLineLength && (e.display.maxLineLength = g,
    ...
    function Kr(e, t, r) {
        ...
        if (r && r.ensure) {
            var s = r.ensure.from.line
              , a = r.ensure.to.line;
            s < o ? (o = s,
            l = ie(t, rt(J(t, s)) + e.wrapper.clientHeight)) : Math.min(a, t.lastLine()) >= l && (o = ie(t, rt(J(t, a)) - e.wrapper.clientHeight),
            l = a)
        }
        return {
            from: o,
    ...
    function Xr(e, t, r, n) {
        null == n && (n = 0);
        var i;
        e.options.lineWrapping || t != r || (r = "before" == t.sticky ? se(t.line, t.ch + 1, "before") : t,
        t = t.ch ? se(t.line, "before" == t.sticky ? t.ch - 1 : t.ch, "after") : t);
        for (var o = 0; o < 5; o++) {
            var l = !1
              , s = ar(e, t)
              , a = r && r != t ? ar(e, r) : s;
            ...
            var u = $r(e, i)
              , c = e.doc.scrollTop
              , h = e.doc.scrollLeft;
            if (null != u.scrollTop && (tn(e, u.scrollTop),
            Math.abs(e.doc.scrollTop - c) > 1 && (l = !0)),
            null != u.scrollLeft && (nn(e, u.scrollLeft),
    ...
    function Jr(e) {
        ...
        if (t) {
            ...
            en(e, ur(e, t.from), ur(e, t.to), t.margin)
        }
    }
    function en(e, t, r, n) {
        var i = $r(e, {
    ...
    function tn(e, t) {
        Math.abs(e.doc.scrollTop - t) < 2 || (yl || Nn(e, {
            top: t
        }),
        rn(e, t, !0),
        yl && Nn(e),
    ...
    function on(e) {
        ...
        return {
            ...
            docHeight: n,
            scrollHeight: n + zt(e) + t.barHeight,
    ...
    function an(e) {
        ...
        e.display.scrollbars.addClass && Gl(e.display.wrapper, e.display.scrollbars.addClass)),
        e.display.scrollbars = new Ms[e.options.scrollbarStyle](function(t) {
            e.display.wrapper.insertBefore(t, e.display.scrollbarFiller),
            ns(t, "mousedown", function() {
    ...
    function fn(e) {
        ...
        e.update = e.mustUpdate && new Os(t,e.mustUpdate && {
            top: e.scrollTop,
    ...
    function pn(e) {
        ...
        e.barMeasure = on(t),
        r.maxLineChanged && !t.options.lineWrapping && (e.adjustWidthTo = jt(t, r.maxLine, r.maxLine.text.length).left + 3,
        t.display.sizerWidth = e.adjustWidthTo,
        e.barMeasure.scrollWidth = Math.max(r.scroller.clientWidth, r.sizer.offsetLeft + e.adjustWidthTo + zt(t) + t.display.barWidth),
        e.maxScrollLeft = Math.max(0, r.sizer.offsetLeft + e.adjustWidthTo - Bt(t))),
    ...
    function gn(e) {
        ...
        (e.updatedDisplay || e.startHeight != t.doc.height) && ln(t, e.barMeasure),
    ...
    function vn(e) {
        var t = e.cm
          , r = t.display
          , n = t.doc;
        if (e.updatedDisplay && Mn(t, e.update),
        ...
        e.scrollToPos) {
            jr(t, Xr(t, pe(n, e.scrollToPos.from), pe(n, e.scrollToPos.to), e.scrollToPos.margin))
        }
        var i = e.maybeHiddenMarkers
          , o = e.maybeUnhiddenMarkers;
        if (i)
            for (var l = 0; l < i.length; ++l)
                i[l].lines.length || D(i[l], "hide");
        if (o)
            for (var s = 0; s < o.length; ++s)
                o[s].lines.length && D(o[s], "unhide");
    ...
    function xn(e, t) {
        e.doc.highlightFrontier < e.display.viewTo && e.state.highlight.set(t, u(Cn, e))
    }
    function Cn(e) {
        var t = e.doc;
        if (!(t.highlightFrontier >= e.display.viewTo)) {
            ...
            t.iter(n.line, Math.min(t.first + t.size, e.display.viewTo + 500), function(o) {
                if (n.line >= e.display.viewFrom) {
                    var l = o.styles
                      , s = o.text.length > e.options.maxHighlightLength ? q(t.mode, n.state) : null
                      , a = me(e, o, n, !0);
                    s && (n.state = s),
                    o.styles = a.styles;
    ...
    function kn(e) {
        ...
        !/^(INPUT|TEXTAREA)$/.test(e.activeElt.nodeName) && e.anchorNode && o(document.body, e.anchorNode) && o(document.body, e.focusNode))) {
    ...
    function Tn(e, r) {
        ...
        if (r.editorIsHidden)
            return Nr(e),
            !1;
        if (!r.force && r.visible.from >= n.viewFrom && r.visible.to <= n.viewTo && (null == n.updateLineNumbers || n.updateLineNumbers >= n.viewTo) && n.renderedView == n.view && 0 == Dr(e))
            return !1;
        Hn(e) && (Nr(e),
        r.dims = wr(e));
        ...
        n.viewFrom < l && l - n.viewFrom < 20 && (l = Math.max(i.first, n.viewFrom)),
    ...
    function Mn(e, t) {
        for (var r = t.viewport, n = !0; ; n = !1) {
            if (n && e.options.lineWrapping && t.oldDisplayWidth != Bt(e))
                ...
                top: Math.min(e.doc.height + It(e.display) - Gt(e), r.top)
            }),
    ...
    function On(e, r, n) {
        function i(t) {
            var r = t.nextSibling;
            return Ll && Fl && e.display.currentWheelTarget == t ? t.style.display = "none" : t.parentNode.removeChild(t),
            r
        }
        for (var o = e.display, l = e.options.lineNumbers, s = o.lineDiv, a = s.firstChild, u = o.view, c = o.viewFrom, h = 0; h < u.length; h++) {
            ...
            if (d.hidden)
                ...
                Ct(e, d, c, n)),
                p && (t(d.lineNumber),
                d.lineNumber.appendChild(document.createTextNode(le(e.options, c)))),
    ...
    function Pn(e) {
        ...
        for (var o = 0; o < i.length; ++o) {
            ...
            a && (u.style.cssText = a),
            "CodeMirror-linenumbers" == s && (e.lineGutter = u,
            u.style.width = (e.lineNumWidth || 1) + "px")
        }
        r.style.display = i.length ? "" : "none",
        An(e)
    }
    function En(e) {
        Pn(e.display),
    ...
    function In(e, t, r, o) {
        ...
        l.lineSpace = i("div", [l.measure, l.lineMeasure, l.selectionDiv, l.cursorDiv, l.lineDiv], null, "position: relative; outline: none");
        var s = i("div", [l.lineSpace], "CodeMirror-lines");
        l.mover = n("div", [s], null, "position: relative"),
        l.sizer = n("div", [l.mover], "CodeMirror-sizer"),
        l.sizerWidth = null,
        l.heightForcer = n("div", null, null, "position: absolute; height: " + Xl + "px; width: 1px;"),
        l.gutters = n("div", null, "CodeMirror-gutters"),
        l.lineGutter = null,
        l.scroller = n("div", [l.sizer, l.heightForcer, l.gutters], "CodeMirror-scroll"),
        l.scroller.setAttribute("tabIndex", "-1"),
        l.wrapper = n("div", [l.scrollbarFiller, l.gutterFiller, l.scroller], "CodeMirror"),
        l.wrapper.setAttribute("translate", "no"),
        Cl && Sl < 8 && (l.gutters.style.zIndex = -1,
    ...
    function Bn(e, t) {
        ...
        if (n && a || i && u) {
            if (i && Fl && Ll)
                e: for (var c = t.target, h = l.view; c != s; c = c.parentNode)
            ...
            if (n && !yl && !Ml && null != o)
                return i && u && tn(e, Math.max(0, s.scrollTop + i * o)),
                nn(e, Math.max(0, s.scrollLeft + n * o)),
                (!i || i && u) && E(t),
                void (l.wheelStartX = null);
            if (i && null != o) {
                var d = i * o
                  , p = e.doc.scrollTop
                  , g = p + l.wrapper.clientHeight;
                d < 0 ? p = Math.max(0, p + d - 50) : g = Math.min(e.doc.height, g + d + 50),
                Nn(e, {
                    top: p,
                    bottom: g
                })
            }
            As < 20 && 0 !== t.deltaMode && (null == l.wheelStartX ? (l.wheelStartX = s.scrollLeft,
    ...
    function Gn(e, t, r) {
        ...
        for (var o = 1; o < t.length; o++) {
            ...
            if (n && !l.empty() ? a > 0 : a >= 0) {
                ...
                o <= r && --r,
                t.splice(--o, 2, new Hs(h ? c : u,h ? u : c))
            }
        }
        return new Ws(t,r)
    }
    function Un(e, t) {
        return new Ws([new Hs(e,t || e)],0)
    }
    function Vn(e) {
        return e.text ? se(e.from.line + e.text.length - 1, g(e.text).length + (1 == e.text.length ? e.from.ch : 0)) : e.to
    }
    function Kn(e, t) {
        if (ae(e, t.from) < 0)
            return e;
        ...
        var r = e.line + t.text.length - (t.to.line - t.from.line) - 1
          , n = e.ch;
        return e.line == t.to.line && (n += Vn(t).ch - t.to.ch),
        se(r, n)
    }
    function jn(e, t) {
        for (var r = [], n = 0; n < e.sel.ranges.length; n++) {
            var i = e.sel.ranges[n];
            r.push(new Hs(Kn(i.anchor, t),Kn(i.head, t)))
        }
    ...
    function Yn(e, t, r) {
        for (var n = [], i = se(e.first, 0), o = i, l = 0; l < t.length; l++) {
            ...
            "around" == r) {
                ...
                n[l] = new Hs(h ? u : a,h ? a : u)
            } else
                n[l] = new Hs(a,a)
        }
        return new Ws(n,e.sel.primIndex)
    }
    function $n(e) {
        e.doc.mode = $(e.options, e.doc.modeOption),
        _n(e)
    }
    function _n(e) {
    ...
    function Zn(e, t, r, n) {
        ...
        if (t.full)
            ...
            if (1 == u.length)
                ...
                m.push(new ys(f + c.text.slice(a.ch),d,n)),
    ...
    function li(e, t, r, n) {
        ...
        i.undone.length = 0;
        var o, l, s = +new Date;
        if ((i.lastOp == n || i.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && i.lastModTime > s - (e.cm ? e.cm.options.historyEventDelay : 500) || "*" == t.origin.charAt(0))) && (o = oi(i, i.lastOp == n)))
            l = g(o.changes),
            0 == ae(t.from, t.to) && 0 == ae(t.from, l.to) ? l.to = Vn(t) : o.changes.push(ni(e, t));
        else {
            var a = g(i.done);
            for (a && a.ranges || ui(e.sel, i.done),
            o = {
                changes: [ni(e, t)],
    ...
    function ai(e, t, r, n) {
        var i = e.history
          , o = n && n.origin;
        r == i.lastSelOp || o && i.lastSelOrigin == o && (i.lastModTime == i.lastSelTime && i.lastOrigin == o || si(e, o, g(i.done), t)) ? i.done[i.done.length - 1] = t : ui(t, i.done),
    ...
    function pi(e, t, r) {
        for (var n = [], i = 0; i < e.length; ++i) {
            var o = e[i];
            if (o.ranges)
                n.push(r ? Ws.prototype.deepCopy.call(o) : o);
            else {
                var l = o.changes
                  , s = [];
                n.push({
    ...
    function wi(e, t, r) {
        var n = {
            ...
            update: function(t) {
                this.ranges = [];
                for (var r = 0; r < t.length; r++)
                    this.ranges[r] = new Hs(pe(e, t[r].anchor),pe(e, t[r].head))
            },
            origin: r && r.origin
        };
        return D(e, "beforeSelectionChange", e, n),
    ...
    function Ci(e, t, r) {
        Si(e, t, r),
        ai(e, e.sel, e.cm ? e.cm.curOp.id : NaN, r)
    }
    function Si(e, t, r) {
        (F(e, "beforeSelectionChange") || e.cm && F(e.cm, "beforeSelectionChange")) && (t = wi(e, t, r)),
        Li(e, Ti(e, t, r && r.bias || (ae(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1), !0)),
        r && !1 === r.scroll || !e.cm || "nocursor" == e.cm.getOption("readOnly") || qr(e.cm)
    }
    function Li(e, t) {
                ...
                if ((null == s.from || (u ? s.from <= t.ch : s.from < t.ch)) && (null == s.to || (c ? s.to >= t.ch : s.to > t.ch))) {
                    ...
                    if (r) {
                        var h = a.find(n < 0 ? 1 : -1)
                          , f = void 0;
                        if ((n < 0 ? c : u) && (h = Oi(e, h, -n, h && h.line == t.line ? o : null)),
                        h && h.line == t.line && (f = ae(h, r)) && (n < 0 ? f < 0 : f > 0))
                            return Mi(e, h, t, n, i)
                    }
                    var d = a.find(n < 0 ? -1 : 1);
                    return (n < 0 ? u : c) && (d = Oi(e, d, n, d.line == t.line ? o : null)),
                    d ? Mi(e, d, t, n, i) : null
                }
            }
        return t
    ...
    function Ni(e, t, r, n, i) {
        var o = n || 1
          , l = Mi(e, t, r, o, i) || !i && Mi(e, t, r, o, !0) || Mi(e, t, r, -o, i) || !i && Mi(e, t, r, -o, !0);
        return l || (e.cantEdit = !0,
        se(e.first, 0))
    }
    function Oi(e, t, r, n) {
        return r < 0 && 0 == t.ch ? t.line > e.first ? pe(e, se(t.line - 1)) : null : r > 0 && t.ch == (n || J(e, t.line)).text.length ? t.line < e.first + e.size - 1 ? se(t.line + 1, 0) : null : new se(t.line,t.ch + r)
    }
    function Ai(e) {
    ...
    function Wi(e, t, r) {
        if (e.cm) {
            if (!e.cm.curOp)
                return yn(e.cm, Wi)(e, t, r);
            if (e.cm.state.suppressEdits)
                return
        }
        if (!(F(e, "beforeChange") || e.cm && F(e.cm, "beforeChange")) || (t = Di(e, t, !0))) {
            var n = vs && !r && Re(e, t.from, t.to);
            if (n)
    ...
    function Hi(e, t) {
        if (1 != t.text.length || "" != t.text[0] || 0 != ae(t.from, t.to)) {
            var r = jn(e, t);
            li(e, t, r, e.cm ? e.cm.curOp.id : NaN),
            Ei(e, t, r, Ee(e, t));
            var n = [];
            Qn(e, function(e, r) {
                r || -1 != f(n, e.history) || (Gi(e.history, t),
                n.push(e.history)),
                Ei(e, t, null, Ee(e, t))
            })
        }
    ...
    function Fi(e, t, r) {
        ...
        if (!n || r) {
            ...
            if (u != s.length) {
                ...
                for (var h = F(e, "beforeChange") || e.cm && F(e.cm, "beforeChange"), d = function(r) {
                    var n = i.changes[r];
                    if (n.origin = t,
                    h && !Di(e, n, !1))
                        return s.length = 0,
                    ...
                    var l = [];
                    Qn(e, function(e, t) {
                        t || -1 != f(l, e.history) || (Gi(e.history, n),
                        l.push(e.history)),
                        Ei(e, n, null, di(e, n))
                    })
    ...
    function Pi(e, t) {
        if (0 != t && (e.first += t,
        e.sel = new Ws(v(e.sel.ranges, function(e) {
            return new Hs(se(e.anchor.line + t, e.anchor.ch),se(e.head.line + t, e.head.ch))
        }),e.sel.primIndex),
        e.cm)) {
    ...
    function Ei(e, t, r, n) {
        if (e.cm && !e.cm.curOp)
            return yn(e.cm, Ei)(e, t, r, n);
        if (t.to.line < e.first)
            return void Pi(e, t.text.length - 1 - (t.to.line - t.from.line));
    ...
    function Ii(e, t, r) {
        var n = e.doc
          ...
          , s = !1
          , a = o.line;
        e.options.lineWrapping || (a = ne(_e(J(n, o.line))),
        ...
        for (var i = 0; i < e.length; ++i) {
            ...
            if (o.ranges) {
                ...
                for (var s = 0; s < o.ranges.length; s++)
                    zi(o.ranges[s].anchor, t, r, n),
                    zi(o.ranges[s].head, t, r, n)
            } else {
    ...
    function Ui(e, t, r, n) {
        var i = t
          , o = t;
        return "number" == typeof t ? o = J(e, de(e, t)) : i = ne(t),
        null == i ? null : (n(o, i) && e.cm && Mr(e.cm, i, r),
        o)
    }
    function Vi(e) {
        this.lines = e,
    ...
    function ji(e, t, r) {
        rt(t) < (e.curOp && e.curOp.scrollTop || e.doc.scrollTop) && _r(e, r)
    }
    function Xi(e, t, r, n) {
        var i = new Fs(e,r,n)
          , o = e.cm;
    ...
    function Yi(e, t, r, n, o) {
        ...
        l.collapsed) {
            if ($e(e, t.line, t, r, l) || t.line != r.line && $e(e, r.line, t, r, l))
        ...
        if (e.iter(u, r.line + 1, function(n) {
            h && l.collapsed && !h.options.lineWrapping && _e(n) == h.display.maxLine && (a = !0),
            l.collapsed && u != t.line && re(n, 0),
            He(n, new Ae(l,u == t.line ? t.ch : null,u == r.line ? r.ch : null), e.cm && e.cm.curOp),
            ++u
        }),
        l.collapsed && e.iter(t.line, r.line + 1, function(t) {
            et(e, t) && re(t, 0)
        }),
        l.clearOnEnter && ns(l, "beforeCursorEnter", function() {
            return l.clear()
        }),
        l.readOnly && (Ne(),
    ...
    function _i(e) {
        return e.findMarks(se(e.first, 0), e.clipPos(se(e.lastLine())), function(e) {
            return e.parent
        })
    }
    function qi(e, t) {
                ...
                if (n && n.length && window.FileReader && window.File)
                    for (var i = n.length, o = Array(i), l = 0, s = function() {
                        ++l == i && yn(t, function() {
                            ...
                            Wi(t.doc, e),
                            xi(t.doc, Un(pe(t.doc, r), pe(t.doc, Vn(e))))
                        })()
                    }, a = function(e, r) {
                        ...
                        if (c) {
                            ...
                            h)
                                for (var d = 0; d < h.length; ++d)
                                    Ri(t.doc, "", h[d].anchor, h[d].head, "drag");
    ...
    function Ji(e, t) {
        if (Cl && (!e.state.draggingText || +new Date - Bs < 100))
            return void z(t);
        if (!W(e, t) && !Pt(e.display, t) && (t.dataTransfer.setData("Text", e.getSelection()),
    ...
    function co(e, t, r) {
        ...
        (zl ? t.metaKey : t.ctrlKey) && "Ctrl" != n && (e = "Ctrl-" + e),
        (zl ? t.ctrlKey : t.metaKey) && "Mod" != n && (e = "Cmd-" + e),
        !r && t.shiftKey && "Shift" != n && (e = "Shift-" + e),
        e
    }
    function ho(e, t) {
        if (Ml && 34 == e.keyCode && e.char)
            return !1;
        var r = Us[e.keyCode];
    ...
    function po(e, t) {
        ...
        mn(e, function() {
            for (var t = n.length - 1; t >= 0; t--)
                Ri(e.doc, "", n[t].from, n[t].to, "+delete");
            qr(e)
        })
    }
    function go(e, t, r) {
    ...
    function mo(e, t, r, n, i) {
        if (e) {
            ...
            if (o) {
                var l, s = i < 0 ? g(o) : o[0], a = i < 0 == (1 == s.level), u = a ? "after" : "before";
                if (s.level > 0 || "rtl" == t.doc.direction) {
                    var c = Yt(t, r);
                    l = i < 0 ? r.text.length - 1 : 0;
                    var h = $t(t, c, l).top;
                    l = k(function(e) {
                        return $t(t, c, e).top == h
    ...
    function yo(e, t, r, n) {
        ...
        var s, a = function(e, r) {
            ...
            return e.options.lineWrapping ? (s = s || Yt(e, t),
            dr(e, t, s, r)) : {
                begin: 0,
                end: t.text.length
            }
        ...
        var p = function(e, t, n) {
            for (var o = function(e, t) {
                return t ? new se(r.line,a(e, 1),"before") : new se(r.line,e,"after")
            }; e >= 0 && e < i.length; e += t) {
                var l = i[e]
                  , s = t > 0 == (1 != l.level)
    ...
    function ko(e, t, r, n) {
        ...
        "handled" != i && "multi" != i || (E(r),
        Ir(e)),
        !!i
    }
    function To(e, t) {
        var r = ho(t, !0);
        return !!r && (t.shiftKey && !e.state.keySeq ? Lo(e, "Shift-" + r, t, function(t) {
            return Co(e, t, !0)
        }) || Lo(e, r, t, function(t) {
    ...
    function No(e) {
        var t = this;
        if (!(e.target && e.target != t.display.input.getField() || (t.curOp.focus = l(),
        W(t, e)))) {
            ...
            var n = To(t, e);
            Ml && (_s = n ? r : null,
            !n && 88 == r && !ss && (Fl ? e.metaKey : e.ctrlKey) && t.replaceSelection("", null, "cut")),
            yl && !Fl && !n && 46 == r && e.shiftKey && !e.ctrlKey && document.execCommand && document.execCommand("cut"),
            18 != r || /\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) || Oo(t)
        }
    }
    function Oo(e) {
        function t(e) {
            18 != e.keyCode && e.altKey || (Gl(r, "CodeMirror-crosshair"),
            A(document, "keyup", t),
    ...
    function Do(e) {
        var t = this;
        if (!(e.target && e.target != t.display.input.getField() || Pt(t.display, e) || W(t, e) || e.ctrlKey && !e.altKey || Fl && e.metaKey)) {
            var r = e.keyCode
              , n = e.charCode;
            if (Ml && r == _s)
                return _s = null,
    ...
    function Wo(e, t) {
        var r = +new Date;
        return Qs && Qs.compare(r, e, t) ? (Zs = Qs = null,
        "triple") : Zs && Zs.compare(r, e, t) ? (Qs = new qs(r,e,t),
        Zs = null,
        "double") : (Zs = new qs(r,e,t),
        Qs = null,
        "single")
    }
    function Ho(e) {
        ...
        if (!(W(t, e) || r.activeTouch && r.input.supportsTouch())) {
            ...
            r.shift = e.shiftKey,
            Pt(r, e))
                return void (Ll || (r.scroller.draggable = !1,
                setTimeout(function() {
            ...
            if (!Uo(t, e)) {
                ...
                n && Fo(t, i, n, o, e) || (1 == i ? n ? Eo(t, n, o, e) : B(e) == r.scroller && E(e) : 2 == i ? (n && vi(t.doc, n),
                setTimeout(function() {
                    return r.input.focus()
                }, 20)) : 3 == i && (Bl ? t.display.input.onContextMenu(e) : zr(t)))
            }
        }
    }
    ...
    function Eo(e, t, r, n) {
        Cl ? setTimeout(u(Rr, e), 0) : e.curOp.focus = l();
        var i, o = Po(e, r, n), s = e.doc.sel;
        e.options.dragDrop && is && !e.isReadOnly() && "single" == r && (i = s.contains(t)) > -1 && (ae((i = s.ranges[i]).from(), t) < 0 || t.xRel > 0) && (ae(i.to(), t) > 0 || t.xRel < 0) ? Io(e, n, t, o) : zo(e, n, t, o)
    }
    function Io(e, t, r, n) {
        var i = e.display
          , o = !1
          , l = yn(e, function(t) {
            ...
            Ll && !Nl || Cl && 9 == Sl ? setTimeout(function() {
        ...
        l.copy = !n.moveOnDrag,
        ns(i.wrapper.ownerDocument, "mouseup", l),
        ns(i.wrapper.ownerDocument, "mousemove", s),
        ns(i.scroller, "dragstart", a),
        ns(i.scroller, "drop", l),
        e.state.delayingBlurEvent = !0,
        setTimeout(function() {
    ...
    function Ro(e, t, r) {
        ...
        if ("line" == r)
            return new Hs(se(t.line, 0),pe(e.doc, se(t.line + 1, 0)));
        var n = r(e, t);
        return new Hs(n.from,n.to)
    }
    function zo(e, t, r, n) {
        function i(t) {
            if (0 != ae(m, t))
                if (m = t,
                "rectangle" == n.unit) {
                    for (var i = [], o = e.options.tabSize, l = h(J(u, r.line).text, r.ch, o), s = h(J(u, t.line).text, t.ch, o), a = Math.min(l, s), g = Math.max(l, s), v = Math.min(r.line, t.line), y = Math.min(e.lastLine(), Math.max(r.line, t.line)); v <= y; v++) {
                        var b = J(u, v).text
                          , w = d(b, a, o);
                        a == g ? i.push(new Hs(se(v, w),se(v, w))) : b.length > w && i.push(new Hs(se(v, w),se(v, d(b, g, o))))
                    }
                    i.length || i.push(new Hs(r,r)),
                    ...
                    var x, C = c, S = Ro(e, t, n.unit), L = C.anchor;
                    ae(S.anchor, L) > 0 ? (x = S.head,
                    L = fe(C.from(), S.anchor)) : (x = S.anchor,
                    L = he(C.to(), S.head));
                    var k = p.ranges.slice(0);
                    k[f] = Bo(e, new Hs(pe(u, L),x)),
                    Ci(u, Gn(e, k, f), _l)
                }
        }
        function o(t) {
            ...
            if (s)
                if (0 != ae(s, m)) {
                    ...
                    i(s);
                    var c = Kr(a, u);
                    (s.line >= c.to || s.line < c.from) && setTimeout(yn(e, function() {
                        b == r && o(t)
                    }), 150)
                } else {
                    var h = t.clientY < y.top ? -20 : t.clientY > y.bottom ? 20 : 0;
                    h && setTimeout(yn(e, function() {
                        b == r && (a.scroller.scrollTop += h,
                        o(t))
                    }), 50)
                }
        }
        ...
        if (n.addNew && !n.extend ? (f = u.sel.contains(r),
        c = f > -1 ? g[f] : new Hs(r,r)) : (c = u.sel.primary(),
        f = u.sel.primIndex),
        "rectangle" == n.unit)
            n.addNew || (c = new Hs(r,r)),
            r = Lr(e, t, !0, !0),
            f = -1;
        else {
            var v = Ro(e, r, n.unit);
        ...
        n.addNew ? -1 == f ? (f = g.length,
        Ci(u, Gn(e, g.concat([c]), f), {
            scroll: !1,
            origin: "*mouse"
        })) : g.length > 1 && g[f].empty() && "char" == n.unit && !n.extend ? (Ci(u, Gn(e, g.slice(0, f).concat(g.slice(f + 1)), 0), {
            scroll: !1,
            origin: "*mouse"
        }),
        p = u.sel) : yi(u, f, c, _l) : (f = 0,
        Ci(u, new Ws([c],0), _l),
        p = u.sel);
        var m = r
        ...
        ns(a.wrapper.ownerDocument, "mousemove", w),
        ns(a.wrapper.ownerDocument, "mouseup", x)
    }
    function Bo(e, t) {
        var r = t.anchor
          , n = t.head
          , i = J(e.doc, r.line);
        if (0 == ae(r, n) && r.sticky == n.sticky)
            return t;
        var o = N(i);
        if (!o)
            return t;
        ...
        var u;
        if (n.line != r.line)
            u = (n.line - r.line) * ("ltr" == e.doc.direction ? 1 : -1) > 0;
        else {
        ...
        var f = o[a + (u ? -1 : 0)]
          ...
          , p = d ? f.from : f.to
          , g = d ? "after" : "before";
        return r.ch == p && r.sticky == g ? t : new Hs(new se(r.line,p,g),n)
    }
    function Go(e, t, r, n) {
        var i, o;
        if (t.touches)
        ...
        for (var a = 0; a < e.display.gutterSpecs.length; ++a) {
            ...
            if (u && u.getBoundingClientRect().right >= i) {
                return D(e, r, e, ie(e.doc, o), e.display.gutterSpecs[a].className, t),
                R(t)
            }
        }
    }
    ...
    function Vo(e, t) {
        Pt(e.display, t) || Ko(e, t) || W(e, t, "contextmenu") || Bl || e.display.input.onContextMenu(t)
    }
    function Ko(e, t) {
    ...
    function Xo(e) {
        ...
        t("lineSeparator", null, function(e, t) {
            ...
            t) {
                ...
                for (var i = r.length - 1; i >= 0; i--)
                    Ri(e.doc, t, r[i], se(r[i].line, r[i].ch + t.length))
            }
        }),
        ...
        t("electricChars", !0),
        t("inputStyle", Hl ? "contenteditable" : "textarea", function() {
        ...
        t("gutters", [], function(e, t) {
            e.display.gutterSpecs = Fn(t, e.options.lineNumbers),
            En(e)
        }, !0),
        ...
        t("lineNumbers", !1, function(e, t) {
            e.display.gutterSpecs = Fn(e.options.gutters, t),
            En(e)
        }, !0),
        ...
        t("workTime", 100),
        t("workDelay", 100),
        t("flattenSpans", !0, _n, !0),
        t("addModeClass", !1, _n, !0),
        t("pollInterval", 100),
    ...
    function $o(e) {
        ...
        e.display.sizerWidth = null) : (Gl(e.display.wrapper, "CodeMirror-wrap"),
        it(e)),
        Sr(e),
        Tr(e),
        tr(e),
    ...
    function _o(e, t) {
        ...
        c(ea, t, !1);
        var n = t.value;
        "string" == typeof n ? n = new zs(n,t.mode,null,t.lineSeparator,t.direction) : t.mode && (n.modeOption = t.mode),
        this.doc = n;
        ...
        Jn(this, n),
        t.autofocus && !Hl || this.hasFocus() ? setTimeout(function() {
            r.hasFocus() && !r.state.focused && Br(r)
        }, 20) : Gr(this);
        for (var l in ta)
            ta.hasOwnProperty(l) && ta[l](this, t[l], Js);
        Hn(this),
        t.finishInit && t.finishInit(this);
        for (var s = 0; s < ra.length; ++s)
            ra[s](this);
        cn(this),
        Ll && t.lineWrapping && "optimizelegibility" == getComputedStyle(o.lineDiv).textRendering && (o.lineDiv.style.textRendering = "auto")
    }
    function qo(e) {
        function t() {
        ...
        var i = e.display;
        ns(i.scroller, "mousedown", yn(e, Ho)),
        Cl && Sl < 11 ? ns(i.scroller, "dblclick", yn(e, function(t) {
            if (!W(e, t)) {
                var r = Lr(e, t);
        ...
        })) : ns(i.scroller, "dblclick", function(t) {
            return W(e, t) || E(t)
        }),
        ns(i.scroller, "contextmenu", function(t) {
            return Vo(e, t)
        }),
        ns(i.input.getField(), "contextmenu", function(t) {
            i.scroller.contains(t.target) || Vo(e, t)
        });
        var o, l = {
            end: 0
        };
        ns(i.scroller, "touchstart", function(t) {
            if (!W(e, t) && !r(t) && !Uo(e, t)) {
        ...
        ns(i.scroller, "touchend", function(r) {
            var o = i.activeTouch;
            if (o && !Pt(i, r) && null != o.left && !o.moved && new Date - o.start < 300) {
                var l, s = e.coordsChar(i.activeTouch, "page");
                l = !o.prev || n(o, o.prev) ? new Hs(s,s) : !o.prev.prev || n(o, o.prev.prev) ? e.findWordAt(s) : new Hs(se(s.line, 0),pe(e.doc, se(s.line + 1, 0))),
        ...
        ns(i.scroller, "touchcancel", t),
        ns(i.scroller, "scroll", function() {
            i.scroller.clientHeight && (tn(e, i.scroller.scrollTop),
            nn(e, i.scroller.scrollLeft, !0),
            D(e, "scroll", e))
        }),
        ns(i.scroller, "mousewheel", function(t) {
            return Bn(e, t)
        }),
        ns(i.scroller, "DOMMouseScroll", function(t) {
            return Bn(e, t)
        }),
        ...
        ns(s, "keydown", yn(e, No)),
        ns(s, "keypress", yn(e, Do)),
        ns(s, "focus", function(t) {
            return Br(e, t)
        }),
    ...
    function Zo(e, t, r, n) {
        ...
        if (n || /\S/.test(s.text)) {
            if ("smart" == r && ((u = o.mode.indent(i, s.text.slice(c.length), s.text)) == Yl || u > 150)) {
                if (!n)
                    return;
                r = "prev"
            }
            ...
            u = 0,
            r = "not";
        "prev" == r ? u = t > o.first ? h(J(o, t - 1).text, null, l) : 0 : "add" == r ? u = a + e.options.indentUnit : "subtract" == r ? u = a - e.options.indentUnit : "number" == typeof r && (u = a + r),
        u = Math.max(0, u);
        var f = ""
          , d = 0;
        ...
        if (d < u && (f += p(u - d)),
        f != c)
            return Ri(o, f, se(t, 0), se(t, c.length), "+input"),
            s.stateAfter = null,
            !0;
    ...
    function Jo(e, t, r, n, i) {
        ...
        if (s && n.ranges.length > 1)
            if (na && na.text.join("\n") == t) {
                if (n.ranges.length % na.text.length == 0) {
                    u = [];
                    for (var c = 0; c < na.text.length; c++)
                        u.push(o.splitLines(na.text[c]))
                }
            } else
                a.length == n.ranges.length && e.options.pasteLinesPerSelection && (u = v(a, function(e) {
                    return [e]
                }));
        for (var h = e.curOp.updateInput, f = n.ranges.length - 1; f >= 0; f--) {
            var d = n.ranges[f]
              , p = d.from()
              , m = d.to();
            d.empty() && (r && r > 0 ? p = se(p.line, p.ch - r) : e.state.overwrite && !s ? m = se(m.line, Math.min(J(o, m.line).text.length, m.ch + g(a).length)) : s && na && na.lineWise && na.text.join("\n") == a.join("\n") && (p = m = se(p.line, 0)));
            var y = {
                from: p,
                to: m,
    ...
    function el(e, t) {
        ...
        if (r)
            ...
            t.isReadOnly() || t.options.disableInput || mn(t, function() {
            ...
            for (var r = e.doc.sel, n = r.ranges.length - 1; n >= 0; n--) {
                ...
                if (!(i.head.ch > 100 || n && r.ranges[n - 1].head.line == i.head.line)) {
                    ...
                    if (o.electricChars) {
                        ...
                        o.electricInput && o.electricInput.test(J(e.doc, i.head.line).text.slice(0, i.head.ch)) && (l = Zo(e, i.head.line, "smart"));
    ...
    function il() {
        ...
        return Ll ? e.style.width = "1000px" : e.setAttribute("wrap", "off"),
        ...
        e.prototype = {
            ...
            indentSelection: bn(function(e) {
                for (var t = this.doc.sel.ranges, r = -1, n = 0; n < t.length; n++) {
                    var i = t[n];
                    if (i.empty())
                        i.head.line > r && (Zo(this, i.head.line, e, !0),
                        r = i.head.line,
                        n == this.doc.sel.primIndex && qr(this));
                    else {
                        var o = i.from()
                          , l = i.to()
                          , s = Math.max(r, o.line);
                        ...
                        0 == o.ch && t.length == u.length && u[n].from().ch > 0 && yi(this.doc, n, new Hs(o,u[n].to()), $l)
                    }
                }
            }),
            ...
            getStateAfter: function(e, t) {
                var r = this.doc;
                return e = de(r, null == e ? r.first + r.size - 1 : e),
                be(this, e + 1, t).state
            },
            cursorCoords: function(e, t) {
                var r, n = this.doc.sel.primary();
                return r = null == e ? n.head : "object" == typeof e ? pe(this.doc, e) : e ? n.from() : n.to(),
                ar(this, r, t || "page")
            },
            ...
            coordsChar: function(e, t) {
                return e = lr(this, e, t || "page"),
                hr(this, e.left, e.top)
            },
            ...
            findPosH: function(e, t, r, n) {
                ...
                t < 0 && (i = -1,
                t = -t);
                for (var o = pe(this.doc, e), l = 0; l < t && (o = ll(this.doc, o, i, r, n),
                !o.hitSide); ++l)
                    ;
                return o
            },
            moveH: bn(function(e, t) {
                ...
                this.extendSelectionsBy(function(n) {
                    return r.display.shift || r.doc.extend || n.empty() ? ll(r.doc, n.head, e, t, r.options.rtlMoveVisually) : e < 0 ? n.from() : n.to()
                }, ql)
            }),
            deleteH: bn(function(e, t) {
                var r = this.doc.sel
                  , n = this.doc;
                r.somethingSelected() ? n.replaceSelection("", null, "+delete") : po(this, function(r) {
            ...
            findPosV: function(e, t, r, n) {
                ...
                t < 0 && (i = -1,
                t = -t);
                for (var l = pe(this.doc, e), s = 0; s < t; ++s) {
                    var a = ar(this, l, "div");
            ...
            moveV: bn(function(e, t) {
                ...
                if (n.extendSelectionsBy(function(l) {
                    ...
                    i.push(s.left);
                    var a = sl(r, s, e, t);
                    return "page" == t && l == n.sel.primary() && _r(r, sr(r, a, "div").top - s.top),
                    a
                }, ql),
                i.length)
            ...
            findWordAt: function(e) {
                ...
                if (r) {
                    ...
                    for (var l = r.charAt(n), s = x(l, o) ? function(e) {
                        return x(e, o)
                    }
                    : /\s/.test(l) ? function(e) {
                        return /\s/.test(e)
                ...
                return new Hs(se(e.line, n),se(e.line, i))
            },
            toggleOverwrite: function(e) {
                null != e && e == this.state.overwrite || ((this.state.overwrite = !this.state.overwrite) ? s(this.display.cursorDiv, "CodeMirror-overwrite") : Gl(this.display.cursorDiv, "CodeMirror-overwrite"),
            ...
            refresh: bn(function() {
                ...
                An(this.display),
                (null == e || Math.abs(e - yr(this.display)) > .5 || this.options.lineWrapping) && Sr(this),
                D(this, "refresh", this)
            }),
    ...
    function ll(e, t, r, n, i) {
        function o() {
            var r = t.line + c;
            return !(r < e.first || r >= e.first + e.size) && (t = new se(r,t.ch,t.sticky),
            u = J(e, r))
        }
        function l(l) {
            var s;
            if ("codepoint" == n) {
                var a = u.text.charCodeAt(t.ch + (r > 0 ? 0 : -1));
                if (isNaN(a))
                    s = null;
                else {
                    var h = r > 0 ? a >= 55296 && a < 56320 : a >= 56320 && a < 57343;
                    s = new se(t.line,Math.max(0, Math.min(u.text.length, t.ch + r * (h ? 2 : 1))),-r)
                }
            } else
                s = i ? yo(e.cm, u, t, r) : vo(u, t, r);
            if (null == s) {
                if (l || !o())
                    return !1;
        ...
        function a(t) {
            if (1 == t.nodeType) {
                ...
                if (d) {
                    ...
                    return void (p.length && (u = p[0].find(0)) && s(ee(e.doc, u.from, u.to).join(h)))
                }
                ...
                for (var v = 0; v < t.childNodes.length; v++)
                    a(t.childNodes[v]);
                /^(pre|p)$/i.test(t.nodeName) && (f = !0),
                g && (c = !0)
            } else
                3 == t.nodeType && s(t.nodeValue.replace(/\u200b/g, "").replace(/\u00a0/g, " "))
        }
        for (var u = "", c = !1, h = e.doc.lineSeparator(), f = !1; a(t),
        t != r; )
            t = t.nextSibling,
            f = !1;
        return u
    ...
    function dl(e, t, r) {
        ...
        for (var d = u.nextSibling, p = a ? a.nodeValue.length - r : 0; d; d = d.nextSibling) {
            if (f = n(d, d.firstChild, 0))
                return cl(se(f.line, f.ch - p), l);
            p += d.textContent.length
        }
        for (var v = u.previousSibling, m = r; v; v = v.previousSibling) {
            if (f = n(v, v.firstChild, -1))
                return cl(se(f.line, f.ch + m), l);
    ...
    var vl = navigator.userAgent
      ...
      , Dl = Nl && (/Mobile\/\w+/.test(vl) || navigator.maxTouchPoints > 2)
      , Wl = /Android/.test(vl)
      , Hl = Dl || Wl || /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(vl)
      , Fl = Dl || /Mac/.test(ml)
      , Pl = /\bCrOS\b/.test(vl)
      , El = /win/i.test(ml)
    ...
    Il && Il >= 15 && (Ml = !1,
    Ll = !0);
    var Rl, zl = Fl && (kl || Ml && (null == Il || Il < 12.11)), Bl = yl || Cl && Sl >= 9, Gl = function(t, r) {
        var n = t.className
          , i = e(r).exec(n);
        if (i) {
    ...
    Rl = document.createRange ? function(e, t, r, n) {
    ...
    var Kl, jl, Xl = 50, Yl = {
        ...
        origin: "+move"
    }, Zl = [""], Ql = /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/, Jl = /[\u0300-\u036f\u0483-\u0489\u0591-\u05bd\u05bf\u05c1\u05c2\u05c4\u05c5\u05c7\u0610-\u061a\u064b-\u065e\u0670\u06d6-\u06dc\u06de-\u06e4\u06e7\u06e8\u06ea-\u06ed\u0711\u0730-\u074a\u07a6-\u07b0\u07eb-\u07f3\u0816-\u0819\u081b-\u0823\u0825-\u0827\u0829-\u082d\u0900-\u0902\u093c\u0941-\u0948\u094d\u0951-\u0955\u0962\u0963\u0981\u09bc\u09be\u09c1-\u09c4\u09cd\u09d7\u09e2\u09e3\u0a01\u0a02\u0a3c\u0a41\u0a42\u0a47\u0a48\u0a4b-\u0a4d\u0a51\u0a70\u0a71\u0a75\u0a81\u0a82\u0abc\u0ac1-\u0ac5\u0ac7\u0ac8\u0acd\u0ae2\u0ae3\u0b01\u0b3c\u0b3e\u0b3f\u0b41-\u0b44\u0b4d\u0b56\u0b57\u0b62\u0b63\u0b82\u0bbe\u0bc0\u0bcd\u0bd7\u0c3e-\u0c40\u0c46-\u0c48\u0c4a-\u0c4d\u0c55\u0c56\u0c62\u0c63\u0cbc\u0cbf\u0cc2\u0cc6\u0ccc\u0ccd\u0cd5\u0cd6\u0ce2\u0ce3\u0d3e\u0d41-\u0d44\u0d4d\u0d57\u0d62\u0d63\u0dca\u0dcf\u0dd2-\u0dd4\u0dd6\u0ddf\u0e31\u0e34-\u0e3a\u0e47-\u0e4e\u0eb1\u0eb4-\u0eb9\u0ebb\u0ebc\u0ec8-\u0ecd\u0f18\u0f19\u0f35\u0f37\u0f39\u0f71-\u0f7e\u0f80-\u0f84\u0f86\u0f87\u0f90-\u0f97\u0f99-\u0fbc\u0fc6\u102d-\u1030\u1032-\u1037\u1039\u103a\u103d\u103e\u1058\u1059\u105e-\u1060\u1071-\u1074\u1082\u1085\u1086\u108d\u109d\u135f\u1712-\u1714\u1732-\u1734\u1752\u1753\u1772\u1773\u17b7-\u17bd\u17c6\u17c9-\u17d3\u17dd\u180b-\u180d\u18a9\u1920-\u1922\u1927\u1928\u1932\u1939-\u193b\u1a17\u1a18\u1a56\u1a58-\u1a5e\u1a60\u1a62\u1a65-\u1a6c\u1a73-\u1a7c\u1a7f\u1b00-\u1b03\u1b34\u1b36-\u1b3a\u1b3c\u1b42\u1b6b-\u1b73\u1b80\u1b81\u1ba2-\u1ba5\u1ba8\u1ba9\u1c2c-\u1c33\u1c36\u1c37\u1cd0-\u1cd2\u1cd4-\u1ce0\u1ce2-\u1ce8\u1ced\u1dc0-\u1de6\u1dfd-\u1dff\u200c\u200d\u20d0-\u20f0\u2cef-\u2cf1\u2de0-\u2dff\u302a-\u302f\u3099\u309a\ua66f-\ua672\ua67c\ua67d\ua6f0\ua6f1\ua802\ua806\ua80b\ua825\ua826\ua8c4\ua8e0-\ua8f1\ua926-\ua92d\ua947-\ua951\ua980-\ua982\ua9b3\ua9b6-\ua9b9\ua9bc\uaa29-\uaa2e\uaa31\uaa32\uaa35\uaa36\uaa43\uaa4c\uaab0\uaab2-\uaab4\uaab7\uaab8\uaabe\uaabf\uaac1\uabe5\uabe8\uabed\udc00-\udfff\ufb1e\ufe00-\ufe0f\ufe20-\ufe26\uff9e\uff9f]/, es = null, ts = function() {
        function e(e) {
        ...
        return function(r, n) {
            ...
            for (var S = 0; S < c; ++S) {
                ...
                if ("," == L)
                    ...
                    for (k = S + 1; k < c && "%" == h[k]; ++k)
                        ;
                    for (var T = S && "!" == h[S - 1] || k < c && "1" == h[k] ? "1" : "N", M = S; M < k; ++M)
                        h[M] = T;
                    S = k - 1
                }
            }
            ...
            for (var D = 0; D < c; ++D)
                if (o.test(h[D])) {
                    ...
                    for (W = D + 1; W < c && o.test(h[W]); ++W)
                        ;
                    for (var H = "L" == (D ? h[D - 1] : u), F = "L" == (W < c ? h[W] : u), P = H == F ? H ? "L" : "R" : u, E = D; E < W; ++E)
                        h[E] = P;
                    D = W - 1
                }
            for (var I, R = [], z = 0; z < c; )
                if (s.test(h[z])) {
                    ...
                    for (var K = G; K < z; )
                        if (a.test(h[K])) {
                            G < K && (R.splice(U, 0, new t(1,G,K)),
                            U += V);
                            var j = K;
                            for (++K; K < z && a.test(h[K]); ++K)
                                ;
                            R.splice(U, 0, new t(2,j,K)),
                            U += V,
                            G = K
                        } else
                            ++K;
                    G < z && R.splice(U, 0, new t(1,G,z))
                }
            return "ltr" == n && (1 == R[0].level && (I = r.match(/^\s+/)) && (R[0].from = I[0].length,
            R.unshift(new t(0,0,I[0].length))),
            1 == g(R).level && (I = r.match(/\s+$/)) && (g(R).to -= I[0].length,
            R.push(new t(0,c - I[0].length,c)))),
            "rtl" == n ? R.reverse() : R
        }
    }(), rs = [], ns = function(e, t, r) {
    ...
    , ls = window.getSelection ? function(e) {
        try {
    ...
    }(), as = null, us = {}, cs = {}, hs = {}, fs = function(e, t, r) {
    ...
    ,
    fs.prototype.eatWhile = function(e) {
    ...
    ,
    fs.prototype.skipTo = function(e) {
    ...
    ,
    fs.prototype.backUp = function(e) {
        this.pos -= e
    }
    ,
    ...
    ,
    fs.prototype.match = function(e, t, r) {
        if ("string" != typeof e) {
    ...
    ,
    fs.prototype.hideFirstChars = function(e, t) {
        this.lineStart += e;
        try {
            return t()
        } finally {
    ...
    ,
    fs.prototype.lookAhead = function(e) {
    ...
    ,
    ps.prototype.baseToken = function(e) {
        if (!this.baseTokens)
            return null;
    ...
    ps.fromSaved = function(e, t, r) {
        return t instanceof ds ? new ps(e,q(e.mode, t.state),r,t.lookAhead) : new ps(e,q(e.mode, t),r)
    }
    ,
    ...
    ys.prototype.lineNo = function() {
        return ne(this)
    }
    ,
    P(ys);
    var bs, ws = {}, xs = {}, Cs = null, Ss = null, Ls = {
        left: 0,
        right: 0,
        top: 0,
        bottom: 0
        ...
        Cl && Sl < 8 && (this.horiz.style.minHeight = this.vert.style.minWidth = "18px")
    };
    ...
    ,
    ks.prototype.enableZeroWidthBar = function(e, t, r) {
        function n() {
    ...
    Os.prototype.signal = function(e, t) {
        F(e, t) && this.events.push(arguments)
    }
    ,
    Os.prototype.finish = function() {
        for (var e = 0; e < this.events.length; e++)
            D.apply(null, this.events[e])
    }
    ;
    var As = 0
      , Ds = null;
    ...
    Ws.prototype.primary = function() {
        return this.ranges[this.primIndex]
    }
    ,
    Ws.prototype.equals = function(e) {
        if (e == this)
            return !0;
        ...
        for (var t = 0; t < this.ranges.length; t++) {
            var r = this.ranges[t]
              , n = e.ranges[t];
            if (!ue(r.anchor, n.anchor) || !ue(r.head, n.head))
                return !1
        }
        return !0
    }
    ...
    Ws.prototype.deepCopy = function() {
        for (var e = [], t = 0; t < this.ranges.length; t++)
            e[t] = new Hs(ce(this.ranges[t].anchor),ce(this.ranges[t].head));
        return new Ws(e,this.primIndex)
    }
    ,
    Ws.prototype.somethingSelected = function() {
    ...
    ,
    Ws.prototype.contains = function(e, t) {
        t || (t = e);
        for (var r = 0; r < this.ranges.length; r++) {
            var n = this.ranges[r];
            if (ae(t, n.from()) >= 0 && ae(e, n.to()) <= 0)
                return r
        }
        return -1
    }
    ...
    ,
    Hs.prototype.to = function() {
        return he(this.anchor, this.head)
    }
    ,
    Hs.prototype.empty = function() {
                ...
                if (e <= o) {
                    ...
                    i.lines && i.lines.length > 50) {
                        for (var l = i.lines.length % 25 + 25, s = l; s < i.lines.length; ) {
                            var a = new Vi(i.lines.slice(s, s += 25));
                            i.height -= a.height,
    ...
    Fs.prototype.clear = function() {
        ...
        if (null != n && t) {
            ...
            var o = Ft(this);
            re(r, Math.max(0, r.height - o)),
            e && (mn(e, function() {
                ji(e, r, -o),
                Mr(e, n, "widget")
            }),
            wt(e, "lineWidgetCleared", e, this, n))
        }
    }
    ,
    Fs.prototype.changed = function() {
        ...
        this.height = null;
        var i = Ft(this) - t;
        i && (et(this.doc, n) || re(n, n.height + i),
        r && mn(r, function() {
    ...
    Es.prototype.clear = function() {
        if (!this.explicitlyCleared) {
            ...
            for (var n = null, i = null, o = 0; o < this.lines.length; ++o) {
                var l = this.lines[o]
                  , s = De(l.markedSpans, this);
                e && !this.collapsed ? Mr(e, ne(l), "text") : e && (null != s.to && (i = ne(l)),
                null != s.from && (n = ne(l))),
                l.markedSpans = We(l.markedSpans, s),
                null == s.from && this.collapsed && !et(this.doc, l) && e && re(l, yr(e.display))
            }
            if (e && this.collapsed && !e.options.lineWrapping)
                for (var a = 0; a < this.lines.length; ++a) {
                    var u = _e(this.lines[a])
                      , c = nt(u);
                    c > e.display.maxLineLength && (e.display.maxLine = u,
                    e.display.maxLineLength = c,
                    e.display.maxLineChanged = !0)
                }
            null != n && e && this.collapsed && Tr(e, n, i + 1),
            this.lines.length = 0,
            this.explicitlyCleared = !0,
            this.atomic && this.doc.cantEdit && (this.doc.cantEdit = !1,
            e && ki(e.doc)),
            e && wt(e, "markerCleared", e, this, n, i),
            t && cn(e),
    ...
    Es.prototype.find = function(e, t) {
        ...
        for (var r, n, i = 0; i < this.lines.length; ++i) {
            var o = this.lines[i]
              , l = De(o.markedSpans, this);
            if (null != l.from && (r = se(t ? o : ne(o), l.from),
            -1 == e))
                return r;
            if (null != l.to && (n = se(t ? o : ne(o), l.to),
            1 == e))
                return n
        }
        return r && {
    ...
    P(Is);
    var Rs = 0
      , zs = function(e, t, r, n, i) {
        if (!(this instanceof zs))
            return new zs(e,t,r,n,i);
        null == r && (r = 0),
        Ki.call(this, [new Vi([new ys("",null)])]),
        this.first = r,
    ...
    zs.prototype = b(Ki.prototype, {
        ...
        getLineHandleVisualStart: function(e) {
            return "number" == typeof e && (e = J(this, e)),
            _e(e)
        },
        lineCount: function() {
            return this.size
        ...
        extendSelectionsBy: wn(function(e, t) {
            mi(this, ve(this, v(this.sel.ranges, e)), t)
        }),
        setSelections: wn(function(e, t, r) {
            if (e.length) {
                for (var n = [], i = 0; i < e.length; i++)
                    n[i] = new Hs(pe(this, e[i].anchor),pe(this, e[i].head || e[i].anchor));
                null == t && (t = Math.min(e.length - 1, this.sel.primIndex)),
                Ci(this, Gn(this.cm, n, t), r)
            }
        }),
        addSelection: wn(function(e, t, r) {
            var n = this.sel.ranges.slice(0);
            n.push(new Hs(pe(this, e),pe(this, t || e))),
        ...
        replaceSelections: wn(function(e, t, r) {
            ...
            for (var s = t && "end" != t && Yn(this, n, t), a = n.length - 1; a >= 0; a--)
                Wi(this, n[a]);
            s ? xi(this, s) : this.cm && qr(this.cm)
        }),
        undo: wn(function() {
            Fi(this, "undo")
        }),
        ...
        clearGutter: wn(function(e) {
            ...
            this.iter(function(r) {
                r.gutterMarkers && r.gutterMarkers[e] && Ui(t, r, "gutter", function() {
        ...
        copy: function(e) {
            var t = new zs(te(this, this.first, this.first + this.size),this.modeOption,this.first,this.lineSep,this.direction);
        ...
        unlinkDoc: function(e) {
            ...
            if (e.history == this.history) {
                ...
                e.history.done = pi(this.history.done, n),
                e.history.undone = pi(this.history.undone, n)
            }
        },
    ...
    zs.prototype.eachLine = zs.prototype.iter;
    for (var Bs = 0, Gs = !1, Us = {
        3: "Pause",
        8: "Backspace",
        9: "Tab",
        13: "Enter",
        ...
        Us[Vs + 48] = Us[Vs + 96] = String(Vs);
    for (var Ks = 65; Ks <= 90; Ks++)
        Us[Ks] = String.fromCharCode(Ks);
    for (var js = 1; js <= 12; js++)
        Us[js + 111] = Us[js + 63235] = "F" + js;
    var Xs = {};
    Xs.basic = {
        Left: "goCharLeft",
        Right: "goCharRight",
    ...
    Xs.default = Fl ? Xs.macDefault : Xs.pcDefault;
    var Ys = {
        selectAll: Ai,
                    ...
                    if (t[n].empty()) {
                        ...
                        if (o)
                            ...
                            i.ch > 0)
                                ...
                                e.replaceRange(o.charAt(i.ch - 1) + o.charAt(i.ch - 2), se(i.line, i.ch - 2), i, "+transpose");
                            else if (i.line > e.doc.first) {
                                var l = J(e.doc, i.line - 1).text;
                                l && (i = new se(i.line,1),
                                e.replaceRange(o.charAt(0) + e.doc.lineSeparator() + l.charAt(l.length - 1), se(i.line - 1, l.length - 1), i, "+transpose"))
                            }
                        r.push(new Hs(i,i))
                    }
                e.setSelections(r)
    ...
    qs.prototype.compare = function(e, t, r) {
        return this.time + 400 > e && 0 == ae(t, this.pos) && r == this.button
    }
    ;
    var Zs, Qs, Js = {
        toString: function() {
    ...
    ia.prototype.init = function(e) {
        ...
        function r(e) {
            if (t(e) && !W(o, e)) {
                ...
                var a = il()
                  , u = a.firstChild;
                o.display.lineSpace.insertBefore(a, o.display.lineSpace.firstChild),
                u.value = na.text.join("\n");
                var c = l();
                Ul(u),
                setTimeout(function() {
                    o.display.lineSpace.removeChild(a),
                    c.focus(),
                    c == s && i.showPrimarySelection()
                }, 50)
            }
        }
        var n = this
          ...
          , s = i.div = e.lineDiv;
        s.contentEditable = !0,
        nl(s, o.options.spellcheck, o.options.autocorrect, o.options.autocapitalize),
        ns(s, "paste", function(e) {
            !t(e) || W(o, e) || el(e, o) || Sl <= 11 && setTimeout(yn(o, function() {
                return n.updateFromDOM()
            }), 20)
        }),
        ns(s, "compositionstart", function(e) {
            n.composing = {
                data: e.data,
                done: !1
            }
        }),
        ns(s, "compositionupdate", function(e) {
            n.composing || (n.composing = {
                data: e.data,
                done: !1
            })
        }),
        ns(s, "compositionend", function(e) {
            n.composing && (e.data != n.composing.data && n.readFromDOMSoon(),
            n.composing.done = !0)
        }),
        ns(s, "touchstart", function() {
    ...
    ia.prototype.showPrimarySelection = function() {
        ...
        if (!o || o.bad || !l || l.bad || 0 != ae(fe(o, l), n) || 0 != ae(he(o, l), i)) {
            ...
            try {
                f = Rl(a.node, a.offset, u.offset, u.node)
            } catch (e) {}
            f && (!yl && t.state.focused ? (e.collapse(a.node, a.offset),
            f.collapsed || (e.removeAllRanges(),
            e.addRange(f))) : (e.removeAllRanges(),
            e.addRange(f)),
            d && null == e.anchorNode ? e.addRange(d) : yl && this.startGracePeriod()),
    ...
    ia.prototype.focus = function() {
        "nocursor" != this.cm.options.readOnly && (this.selectionInEditor() && l() == this.div || this.showSelection(this.prepareSelection(), !0),
        this.div.focus())
    }
    ,
    ...
    ia.prototype.receivedFocus = function() {
        function e() {
            r.cm.state.focused && (r.pollSelection(),
            r.polling.set(r.cm.options.pollInterval, e))
        }
        var t = this
          , r = this;
        this.selectionInEditor() ? setTimeout(function() {
            return t.pollSelection()
        }, 20) : mn(this.cm, function() {
    ...
    ia.prototype.pollContent = function() {
        ...
        var e = this.cm
          ...
          , n = r.from()
          , i = r.to();
        if (0 == n.ch && n.line > e.firstLine() && (n = se(n.line - 1, J(e.doc, n.line - 1).length)),
        i.ch == J(e.doc, i.line).text.length && i.line < e.lastLine() && (i = se(i.line + 1, 0)),
        n.line < t.viewFrom || i.line > t.viewTo - 1)
            return !1;
        var o, l, s;
        n.line == t.viewFrom || 0 == (o = kr(e, n.line)) ? (l = ne(t.view[0].line),
        s = t.view[0].node) : (l = ne(t.view[o].line),
        s = t.view[o - 1].node.nextSibling);
        var a, u, c = kr(e, i.line);
        if (c == t.view.length - 1 ? (a = t.viewTo - 1,
        u = t.lineDiv.lastChild) : (a = ne(t.view[c + 1].line) - 1,
        u = t.view[c + 1].node.previousSibling),
        !s)
            return !1;
        for (var h = e.doc.splitLines(hl(e, s, u, l, a)), f = ee(e.doc, se(l, 0), se(a, J(e.doc, a).text.length)); h.length > 1 && f.length > 1; )
            if (g(h) == g(f))
                h.pop(),
                f.pop(),
                a--;
        ...
        if (1 == h.length && 1 == f.length && l == n.line)
            for (; d && d > n.ch && b.charCodeAt(b.length - p - 1) == w.charCodeAt(w.length - p - 1); )
                d--,
                p++;
        ...
        return h.length > 1 || h[0] || ae(C, S) ? (Ri(e.doc, h, C, S, "+input"),
        !0) : void 0
    }
    ,
    ...
    ia.prototype.updateFromDOM = function() {
        var e = this;
        !this.cm.isReadOnly() && this.pollContent() || mn(this.cm, function() {
            return Tr(e.cm)
        })
    }
    ,
    ...
    ia.prototype.onKeyPress = function(e) {
        ...
        this.cm.isReadOnly() || yn(this.cm, Jo)(this.cm, String.fromCharCode(null == e.charCode ? e.keyCode : e.charCode), 0))
    }
    ,
    ...
    oa.prototype.init = function(e) {
        function t(e) {
            if (!W(i, e)) {
                if (i.somethingSelected())
                    ...
                    "cut" == e.type ? i.setSelections(t.ranges, null, $l) : (n.prevInput = "",
                    o.value = t.text.join("\n"),
                    Ul(o))
                }
        ...
        ns(o, "input", function() {
            Cl && Sl >= 9 && r.hasSelection && (r.hasSelection = null),
            n.poll()
        }),
        ns(o, "paste", function(e) {
            W(i, e) || el(e, i) || (i.state.pasteIncoming = +new Date,
            n.fastPoll())
        }),
        ns(o, "cut", t),
        ns(o, "copy", t),
        ns(e.scroller, "paste", function(t) {
            if (!Pt(e, t) && !W(i, t)) {
                if (!o.dispatchEvent)
                    return i.state.pasteIncoming = +new Date,
                    void n.focus();
                var r = new Event("paste");
                r.clipboardData = t.clipboardData,
                o.dispatchEvent(r)
            }
        }),
    ...
    oa.prototype.focus = function() {
        if ("nocursor" != this.cm.options.readOnly && (!Hl || l() != this.textarea))
            try {
                this.textarea.focus()
            } catch (e) {}
    }
    ...
    oa.prototype.poll = function() {
        var e = this
          ...
          , r = this.textarea
          , n = this.prevInput;
        if (this.contextMenuPending || !t.state.focused || ls(r) && !n && !this.composing || t.isReadOnly() || t.options.disableInput || t.state.keySeq)
            return !1;
        var i = r.value;
        if (i == n && !t.somethingSelected())
            return !1;
        if (Cl && Sl >= 9 && this.hasSelection === i || Fl && /[\uf700-\uf7ff]/.test(i))
        ...
        return mn(t, function() {
            Jo(t, i.slice(l), n.length - l, null, e.composing ? "*compose" : null),
    ...
    oa.prototype.onContextMenu = function(e) {
        ...
        function r() {
            if (n.contextMenuPending == r && (n.contextMenuPending = !1,
            ...
            null != l.selectionStart)) {
                ...
                var e = 0
                  , s = function() {
                    o.selForContextMenu == i.doc.sel && 0 == l.selectionStart && l.selectionEnd > 0 && "​" == n.prevInput ? yn(i, Ai)(i) : e++ < 10 ? o.detectingSelectAll = setTimeout(s, 500) : (o.selForContextMenu = null,
                    o.input.reset())
                };
        ...
        if (s && !Ml) {
            i.options.resetSelectionOnContextMenu && -1 == i.doc.sel.contains(s) && yn(i, Ci)(i.doc, Un(s), $l);
            var u = l.style.cssText
              , c = n.wrapper.style.cssText
              , h = n.wrapper.offsetParent.getBoundingClientRect();
            ...
            var f;
            if (Ll && (f = window.scrollY),
            o.input.focus(),
            Ll && window.scrollTo(null, f),
            o.input.reset(),
    ...
    for (var sa in zs.prototype)
        zs.prototype.hasOwnProperty(sa) && f(la, sa) < 0 && (_o.prototype[sa] = function(e) {
            return function() {
    ...
    _o.defineMode = function(e) {
        _o.defaults.mode || "null" == e || (_o.defaults.mode = e),
        j.apply(this, arguments)
    }
    ,
    _o.defineMIME = X,
    _o.defineMode("null", function() {
        return {
            token: function(e) {
                return e.skipToEnd()
            }
    ...
    _o.defineMIME("text/plain", "null"),
    _o.defineExtension = function(e, t) {
        _o.prototype[e] = t
    }
    ,
