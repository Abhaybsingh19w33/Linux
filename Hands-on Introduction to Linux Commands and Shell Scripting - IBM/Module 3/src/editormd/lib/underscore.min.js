!function(n, r) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = r() : "function" == typeof define && define.amd ? define("underscore", r) : (n = n || self,
    function() {
        var t = n._
          , e = n._ = r();
    ...
    "function" != typeof /./ && "object" != typeof Int8Array && "function" != typeof T && (k = function(n) {
    ...
    var Zr = Yr({
        ...
        partition: Vr,
        toArray: function(n) {
            return n ? U(n) ? i.call(n) : S(n) ? n.match(Pr) : er(n) ? _r(n, Tn) : jn(n) : []
        },
        size: function(n) {
